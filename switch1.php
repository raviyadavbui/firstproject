...
function SwitchCase()
{
    ...
    <input type="radio" id="add"checked name="mtype" value="0"><label for="add">Add</label>
    <input type="radio" id="sub" name="mtype" value="1"><label for="sub">Sub</label>
    <input type="radio" id="mul" name="mtype" value="2"><label for="mul">Mul</label>
    <input type="radio" id="div" name="mtype" value="3"><label for="div">Div</label>
    <input type="radio" id="mod" name="mtype" value="4"><label for="mod">Mod</label><br>
